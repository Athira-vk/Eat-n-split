...
export default function App() {
  ...
  function handleSelectiion(friend) {
...
function Friend({ friend, onSelection, selectedFriend }) {
  const isSelecton = selectedFriend?.id === friend.id;

  return (
    <li className={isSelecton ? "selected" : ""}>
